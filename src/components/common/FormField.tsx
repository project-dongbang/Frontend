...
export function Input({ label, required, error, hint, className = '', ...props }: InputProps) {
  return <FormField label={label} required={required} error={error} hint={hint}><input className={`field-control ${className}`.trim()} required={required} {...props} /></FormField>
}
...
export function Textarea({ label, required, error, hint, className = '', ...props }: TextareaProps) {
  return <FormField label={label} required={required} error={error} hint={hint}><textarea className={`field-control field-textarea ${className}`.trim()} required={required} {...props} /></FormField>
}
...
export function Select({ label, required, error, hint, className = '', children, ...props }: SelectProps) {
  return <FormField label={label} required={required} error={error} hint={hint}><select className={`field-control ${className}`.trim()} required={required} {...props}>{children}</select></FormField>
}
