...
const adminNavItems = [{ label: '대시보드', icon: 'home' }, { label: '멤버 관리', icon: 'users' }, { label: '일정 · 행사', icon: 'calendar' }, { label: '출석 관리', icon: 'check' }, { label: '회비 관리', icon: 'wallet' }]
const memberNavItems = [{ label: '대시보드', icon: 'home' }, { label: '일정 · 행사', icon: 'calendar' }, { label: '내 출석', icon: 'check' }, { label: '회비', icon: 'wallet' }]
